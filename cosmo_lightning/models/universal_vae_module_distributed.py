...
class UniversalVAEModuleDistributed(LightningModule):
    def __init__(
        self,
        variables: List[str],
        patcher_type: str,
    ...
    def _load_pretrained_weights(self, pretrained_path):   
        ...
        if ".pt" in pretrained_path:
            model = torch.load(pretrained_path, weights_only=False, map_location="cpu")
    ...
    def training_step(self, batch, batch_idx):
        ...
        # print('global rank', torch.distributed.get_rank(), dataset_name, videos.shape)
