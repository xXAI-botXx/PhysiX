...
from cosmo_lightning.data.distributed_multi_datamodule import DistributedMultiDatasetDataModule
from cosmo_lightning.models.universal_vae_module_distributed import UniversalVAEModuleDistributed
...
def main():
    ...
    cli = LightningCLI(
        model_class=UniversalVAEModuleDistributed,
        datamodule_class=DistributedMultiDatasetDataModule,
