...
from cosmo_lightning.models.universal_multi_encoder_vae_module import UniversalMultiEncoderVAEModule
...
def main():
    ...
    cli = LightningCLI(
        model_class=UniversalMultiEncoderVAEModule,
        datamodule_class=MultiDatasetDataModule,
