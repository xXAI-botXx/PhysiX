...
from well_utils.benchmarks.well_generation_pipeline import WellGenerationPipeline
...
class VideoEvaluator:
    ...
    def _initialize_pipeline(self) -> ARBaseGenerationPipeline:
        """Initialize the generation pipeline with configured parameters."""
        # return WellGenerationPipeline(
        #     model_path=self.args.checkpoint_dir,
        #     model_type="UNetConvNext",
        #     device="cuda" if torch.cuda.is_available() else "cpu",
        # )
        return ARBaseGenerationPipeline(
            inference_type="base",
