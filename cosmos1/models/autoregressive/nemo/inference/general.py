...
"""
torchrun --nproc-per-node 4 -m cosmos1.models.autoregressive.nemo.inference.general \
--input_type video \
--video_save_name ./nemo_generated_video2.mp4 \
--input_image_or_video_path cosmos1/models/autoregressive/assets/v1p0/batch_inputs/0.mp4 \
--ar_model_dir /data0/arshkon/checkpoints/cosmos_inference/finetuned/epoch=0-step=1474-last \
--encoder_path /data0/arshkon/checkpoints/cosmos/Cosmos-1.0-Tokenizer-DV8x16x16/encoder.jit \
--decoder_path /data0/arshkon/checkpoints/cosmos/Cosmos-1.0-Tokenizer-DV8x16x16/decoder.jit \
--guardrail_dir /data0/arshkon/checkpoints/cosmos/Cosmos-1.0-Guardrail \
...
"""
torchrun --nproc-per-node 1 --master_port 12345 -m cosmos1.models.autoregressive.nemo.inference.general \
--input_type video \
--input_image_or_video_path cosmos1/models/autoregressive/assets/v1p0/batch_inputs/0.mp4 \
--ar_model_dir /data0/arshkon/checkpoints/cosmos/finetuned/Cosmos-1.0-Autoregressive-4B/nemo \
--encoder_path /data0/arshkon/checkpoints/cosmos/Cosmos-1.0-Tokenizer-DV8x16x16/encoder.jit \
--decoder_path /data0/arshkon/checkpoints/cosmos/Cosmos-1.0-Tokenizer-DV8x16x16/decoder.jit \
--guardrail_dir /data0/arshkon/checkpoints/cosmos/Cosmos-1.0-Guardrail \
